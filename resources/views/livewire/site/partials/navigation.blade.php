    ...
    <div class="bg-gray-100 dark:bg-gray-800 shadow-md">
        <div class="w-full container px-2">
            <div class="hidden lg:flex lg:items-center justify-between py-3">
                ...
                <div class="hidden lg:flex lg:items-center">
                    <a href="#" class="text-gray-800 dark:text-gray-200 text-sm font-semibold hover:text-blue-600 mr-4">Início</a>
                    @livewire('site.components.dropdown', ['title' => 'Quem Somos', 'options' => ['História' => 'home', 'Projetos' => 'home', 'Organograma Institucional' => 'home', 'Parceiros' => 'home']])
